...
export function BucketRail({ buckets, active, onSelect }: Props) {
  return (
    <nav className="flex w-44 shrink-0 flex-col gap-0.5 border-r border-line bg-surface p-2" aria-label="Buckets">
